<template>
  <div>
    <el-popover
      ...
      <pre>
         如选择“运动员证注销”，各个选项提交的材料如下：

        运动员本人申请——运动员本人手写或签字的注销申请，需得到俱乐部负责人签字批准并盖章

        运动员退役/转岗——运动员本人手写或签字的退役申请，需得到俱乐部负责人签字批准并盖章

        运动员违法违规——俱乐部对运动员违法违规行为的说明，需由俱乐部负责人签字并盖章，
...
export default {
  ...
  data() {
    return {
      causes: [
        { value: "运动员本人申请", label: "运动员本人申请" },
        { value: "运动员退役/转岗", label: "运动员退役/转岗" },
        { value: "运动员违法违规", label: "运动员违法违规" },
      ],
      dropForm: {
        dropCause: "",
        dropFile: "",

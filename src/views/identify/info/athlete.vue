  ...
  <div>
    ...
    >
      ...
      <el-form-item class="width" label="游戏项目：" prop="project">
        <el-col :span="10">
          <!-- <el-input v-model="info.project"></el-input> -->
      ...
      <el-form-item class="width" label="证件类型：" prop="cardType">
      ...
      <el-form-item class="width" label="证件号码：" prop="idcardNumber">
        <el-col :span="10">
  ...
  methods: {
    pushNext() {
      ...
      this.$refs.infoRef.validate(async (valid) => {
        ...
        // console.log(",,",this.info.birth);
        this.$store.commit("certificate/SET_ATHELE", this.info);
        // console.log("..",this.$store.getters.ATHLETE_INFO)
        await this.$router.push("/identify/first/confirm");
      });
    },
    // handleChange(value){

<template>
    ...
    <div class="personalInfo">
        <!-- 注册表单 -->
        <el-form
            :rules="personalRegisterInfoRules"
            ref="personalRegisterRef"
            :model="personalRegisterInfo"
            label-width="82px"
            class="changeInput"
            size="small"
            label-position="left"
        >
            <el-form-item label="用户名:" prop="username">
                <el-col :span="12">
                    <el-input v-model="personalRegisterInfo.username"></el-input>
                </el-col>
            </el-form-item>
            <el-form-item label="密码:" prop="password">
                <el-col :span="16">
                    <el-input
                        ...
                        v-model="personalRegisterInfo.password"
                    ></el-input>
                </el-col>
            </el-form-item>
            <el-form-item label="确认密码:" prop="repeatPassword">
                <el-col :span="16">
                    <el-input
                        type="password"
                        auto-complete="new-password"
                        v-model="personalRegisterInfo.repeatPassword"
                    ></el-input>
                </el-col>
            </el-form-item>
            <el-divider></el-divider>
            <el-form-item label="手机号:" prop="info">
                <el-col :span="12">
                    <el-input
                        v-model="personalRegisterInfo.info"
                    ></el-input>
                </el-col>
                <mybutton
                    width="100"
            ...
            <el-form-item label="验证码:" prop="verCode">
                <el-col :span="7">
                    <el-input v-model="personalRegisterInfo.verificationCode"></el-input>
                </el-col>
            </el-form-item>
            <el-form-item label="邀请码:">
                <el-col :span="16">
                    <el-input v-model="personalRegisterInfo.invitationCode"></el-input>
                </el-col>
            </el-form-item>
            <span class="inviteCodeTip"
                >获得企业或俱乐部发放邀请码的用户填写</span
            >
            <div class="userCheckBox">
                <el-checkbox
                    v-model="personalRegisterInfo.agreeUserContack"
                ></el-checkbox>
            ...
            <div class="perButtons">
                <mybutton
                    type="orange"
                    class="button"
                    @click="handlePerRegister"
                    >注册</mybutton
                >
                <mybutton class="button" @click="returnlogin">取消</mybutton>
            </div>
        </el-form>
...
export default {
    ...
    data() {
        var validatePass = (rules, value, callback) => {
            ...
            if (this.personalRegisterInfo.password != null) {
                ...
                this.$refs.personalRegisterRef.validateField("repeatPassword");
                callback();
            }
            callback();
        };
        var validateRepeatPass = (rules, value, callback) => {
            if (this.personalRegisterInfo.password != value) {
        ...
        return {
            ...
            personalRegisterInfo: {
                ...
                invitationCode: "",
                type: 1,
                agreeUserContack: false,
            },
            // 个人注册 填写信息校验规则
            personalRegisterInfoRules: {
                username: [
                    {
                        required: true,
                        message: "请输入用户名",
    ...
    methods: {
        ...
        // 获取手机号验证码
        async getCheckCode() {
            this.$refs.personalRegisterRef.validateField('info', async error => {
                // error是报错信息，若为空，则表明手机号验证没问题，发送验证码
                if(error) return this.$message.error('请先填写正确的手机号！');
                const resp = await this.$store.dispatch('other/sendVerCode', {
                    info: this.personalRegisterInfo.info,
                });
                if(resp) {
                    this.isSend = true;
                    this.timeout = 60;
        ...
        // 处理个人注册
        handlePerRegister() {
            this.$refs.personalRegisterRef.validate(async (value) => {
                if (!value) return this.$message.error("请先完善必填信息！");
                if(!this.personalRegisterInfo.agreeUserContack) return this.$message.error('请先同意用户条约！');
                this.$store.dispatch('user/registerUser', this.personalRegisterInfo);
            });
        },
    },
};
